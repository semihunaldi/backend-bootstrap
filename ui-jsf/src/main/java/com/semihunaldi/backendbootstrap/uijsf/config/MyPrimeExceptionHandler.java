...
public class MyPrimeExceptionHandler extends ExceptionHandlerWrapper {

	private static final Logger LOG = Logger.getLogger(org.primefaces.application.exceptionhandler.PrimeExceptionHandler.class.getName());
	private static final String DATE_FORMAT_PATTERN = "yyyy-MM-dd HH:mm:ss";

	private final ExceptionHandler wrapped;

	private Map<String, String> errorPages = ImmutableMap.of("java.lang.Throwable", "/customErrors/errorOccured.xhtml");

	public MyPrimeExceptionHandler(ExceptionHandler wrapped) {
